...
public class FiveStageSimulator {
	...
	public FiveStageSimulator(Memory mem)
	{
		 this.mem = mem;
		 this.regs = new RegisterFile( );
		 this.alu = new SimpleALU(regs, mem);
		 this.cpiMap = new CPIMap(1);
	}
	
	public FiveStageSimulator(Memory mem, RegisterFile regs, SimpleALU alu, CPIMap cpiMap) {
		this.mem = mem;
		this.regs = regs;
		this.alu = alu;
		this.cpiMap = cpiMap;
